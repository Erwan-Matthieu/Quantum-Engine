...
import static com.quantum.utils.Utils.listToArray;

public class HeightMapMesh {
    
    private static final int MAX_COLOUR = 255 * 255 * 255;

    public static final float   START_X = -100.f,
                                START_Z = -100.f;
    ...
    public HeightMapMesh(float minY, float maxY, ByteBuffer buf, int width, int height, String textureFile, int textInc) throws Exception {
        this.minY = minY;
        this.maxY = maxY;
        ...
        Material material = new Material(0.0f, texture);
